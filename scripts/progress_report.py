...
MODULES = [
    ...
    },
    {
        ...
        "layer": "L3-Biz",
        "check_files": ["src/ragent/rag/rewriter/query_rewriter.py"],
    },
    {
        "id": "rag-intent",
        "name": "意图识别 (rag/intent)",
        "layer": "L3-Biz",
        "check_files": ["src/ragent/rag/intent/intent_classifier.py"],
    },
    {
        "id": "rag-retrieval",
        "name": "多路检索 (rag/retrieval)",
        "layer": "L3-Biz",
        "check_files": ["src/ragent/rag/retrieval/retriever.py"],
    },
    {
        "id": "rag-memory",
        "name": "会话记忆 (rag/memory)",
        "layer": "L3-Biz",
        "check_files": ["src/ragent/rag/memory/session_memory.py"],
    },
    {
        "id": "rag-prompt",
        "name": "Prompt组装 (rag/prompt)",
        "layer": "L3-Biz",
        "check_files": ["src/ragent/rag/prompt/prompt_builder.py"],
    },
    {
        "id": "rag-chain",
